...
namespace FormDemoProject.Controllers
{
    ...
    public class FormsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,CreatedBy")] Form form)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,CreatedBy")] Form form)
        {
            if (ModelState.IsValid)
            {
